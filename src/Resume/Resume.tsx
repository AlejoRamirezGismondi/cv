        ...
        <div className={'right-content'}>
          <div className={'container'}>
            <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 zoomAndPan="magnify"
                 role="img" aria-label="Organic Rounded Shape">
            ...
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"
              ...
              <path d="M62.7,-19.6C69.2,-0.3,54.1,26.7,34.8,38.4C15.6,50.2,-7.8,46.6,-24.2,34.5C-40.5,22.3,-49.7,1.6,-44.5,-15.9C-39.3,-33.4,-19.6,-47.7,4.2,-49C28.1,-50.4,56.2,-38.9,62.7,-19.6Z" transform="translate(100 100)" />
            </svg>
            <div style={{zIndex: 10}} className={'education'}>
              ...
              <ul>
                ...
                <div>
                  <p>Online Courses</p>
                  <ul>
                    <li><a href={'https://www.coursera.org/account/accomplishments/certificate/9J8E74R8G7J3'}>Bootstrap 4: Universidad Austral</a></li>
                    <li><a href={'https://www.coursera.org/account/accomplishments/certificate/Q5D6XV4J3C94'}>Introduction to Cyber Attacks: NYU</a></li>
                    <li><a href={'https://www.coursera.org/account/accomplishments/certificate/NRQFMEPG3T6N'}>Cyber Attacks Countermeasures: NYU</a></li>
                    <li>Others</li>
                  </ul>
                </div>
              </ul>
          ...
          <div className={'work-experience'}>
            ...
            <Masonry columns={{md: 2, sm: 1}} spacing={2}>
              ...
              <Card>
                <CardContent className={'card'}>
                  <div>
                    <p>Front-end Web Developer for Pulse Studio in <a href='https://www.elegimejor.com.ar/'>ElegiMejor.com.ar</a></p>

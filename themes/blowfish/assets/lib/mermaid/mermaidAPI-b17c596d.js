...
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-03ae1c00.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-d83bc35d.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-1625522e.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-7a51ae2c.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-1a65387e.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-db1fc7f4.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-e88d32e4.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-fe866de1.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-69aa38ad.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-ef563e47.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-b31c380f.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-c7d82979.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-1f7b1681.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-5aa2757a.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-77dc0d08.js");
...
//# sourceMappingURL=mermaidAPI-b17c596d.js.map
